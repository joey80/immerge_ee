...
class Settings
{
    ...
    public $site_id;
    public $moduleClassName = VISITOR_CLASS_NAME;
    public $moduleConfigName = VISITOR_CLASS_NAME;
    public $settings; // Current Site Settings
    ...
    public function getFieldtypeSettings($field_id=false, $settings=false, $fieldtype=null)
    {
        if ($fieldtype) {
            $defaultSettings = ee('App')->get($this->moduleClassName)->get('settings_fieldtype-'.$fieldtype);
        } else {
...
/* Location: ./system/user/addons/visitor/Service/Settings.php */